...
def parse_args():
    ...
    parser.add_argument("--sim", action="store_true", default=True, help="Enable built-in synthetic racing physics simulator")
    parser.add_argument("--no-sim", dest="sim", action="store_false", help="Disable synthetic telemetry simulator (listen only to live game UDP)")
